...
const AboutUs = () => {
  ...
  const team = [
    ...
    },
    {
      name:"Thiago",
      job:"Quality Assurance",
      linkedin:"https://www.linkedin.com/in/thiago-henrique-monserrat-rezende-83562b213/",
  ...
  return (
    <>
      <OurTeam>
        ...
        <p  data-aos="fade-up" >
          O projeto ProWorking foi criado para agilizar e facilitar a contratação de pessoas
          em serviços informais. O projeto foi criado pelos os estudantes em desenvolvimento
          web da Kenzie Academy Brasil, e representa o projeto final do módulo M3 do curso
          fullstack. 
        </p>
        <h3  data-aos="fade-up" data-aos-delay='150'>Nosso Time Dev</h3>
        <div  data-aos="fade-in"  data-aos-delay='1050' className="linha"></div>
        <div>
          <ul>
